...
Pod::Spec.new do |s|
  s.name             = 'RPRouter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RPRouter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mrcloud/RPRouter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mrcloud' => 'florianp37@me.com' }
  s.source           = { :git => 'https://github.com/mrcloud/RPRouter.git', :tag => s.version.to_s }
